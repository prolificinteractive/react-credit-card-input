...
var CreditCardInput = function (_Component) {
  ...
  function CreditCardInput(props) {
    ...
    _this.handleCardNumberBlur = function () {
      ...
      return function (e) {
        if (!payment.fns.validateCardNumber(e.target.value)) {
          _this.setFieldInvalid('Card number is invalid');
        }
    ...
    _this.handleCardNumberChange = function () {
      ...
      return function (e) {
        var enableZipInput = _this.props.enableZipInput;
    ...
    _this.handleCardExpiryBlur = function () {
      ...
      return function (e) {
        ...
        var expiryError = isExpiryInvalid(cardExpiry);
        if (expiryError) {
          _this.setFieldInvalid(expiryError);
        }
    ...
    _this.handleCardCVCBlur = function () {
      ...
      return function (e) {
        if (!payment.fns.validateCardCVC(e.target.value)) {
          _this.setFieldInvalid('CVC is invalid');
        }
    ...
    _this.handleCardZipBlur = function () {
      ...
      return function (e) {
        if (!isZipValid(e.target.value)) {
          _this.setFieldInvalid('Zip code is invalid');
        }
    ...
    _this.setFieldInvalid = function (errorText) {
    ...
    _this.render = function () {
      ...
      var _this$props = _this.props,
          cardImageClassName = _this$props.cardImageClassName,
          cardImageStyle = _this$props.cardImageStyle,
          cardCVCInputProps = _this$props.cardCVCInputProps,
          cardZipInputProps = _this$props.cardZipInputProps,
          cardExpiryInputProps = _this$props.cardExpiryInputProps,
          cardNumberInputProps = _this$props.cardNumberInputProps,
          cardCVCInputRenderer = _this$props.cardCVCInputRenderer,
          cardExpiryInputRenderer = _this$props.cardExpiryInputRenderer,
          cardNumberInputRenderer = _this$props.cardNumberInputRenderer,
          cardZipInputRenderer = _this$props.cardZipInputRenderer,
          containerClassName = _this$props.containerClassName,
          containerStyle = _this$props.containerStyle,
          dangerTextClassName = _this$props.dangerTextClassName,
          dangerTextStyle = _this$props.dangerTextStyle,
          ...
          invalidStyle = _this$props.invalidStyle;
